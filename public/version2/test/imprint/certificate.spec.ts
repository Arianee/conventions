...
it('3/ ArianeeProduct Certificate-i18n', async (done) => {
    const content = {
        ...
        "language": "en-US",
        "name": "Avenger Chronograph 45 Night Mission",
        "brandInternalId": "V13317101L1X1",
        "category": "accessory",
        "subCategory": "watch",
        "intended": "neutral",
        "serialnumber": [{"type": "serialnumber", "value": "7182695"}],
        "description": "Bold, extremely robust and shock resistant, the Avenger Chronograph 45 Night Mission combines precision with a powerful design in a lightweight case. As a true Breitling Avenger, it can be used wearing gloves and offers unrivalled safety and reliability to any airborne adventurer. The Night Mission interpretation of the Avenger Chronograph 45 features a sturdy 45mm DLC-coated titanium case, black or khaki dial and a matching black or khaki military leather strap that fits either a DLC-coated stainless-steel pin buckle or folding clasp. Its specific Arabic numerals recall the stenciled numbers used on the decks of aircraft carriers. Thanks to its rugged bezel and its special grip-pattern on the crown & chronograph pushers, the Avenger Chronograph 45 Night Mission can be easily operated wearing gloves.\n\nTechnical Details\nDiameter: 45.0mm, \nCase Material: DLC-Coated Titanium, \nDial Color: Green, \nBracelet Material: Calfskin Leather, \nBuckle Material: DLC-Coated Stainless Steel, \nCaliber: Breitling 13",
        "externalContents": [{
            "type": "proofLinkAction",
            "title": "My account",
            "url": "https://www.breitling.com/zz-zz/my-account/ewarranty/card-certificat"
        }, {
            "type": "website",
            "title": "Contact",
            "url": "https://www.breitling.com/zz-zz/contact/"
        }, {
            "type": "website",
            "title": "Find your nearest Breitling retailer",
            "url": "https://www.breitling.com/zz-zz/stores/"
        }],
        "medias": [{
            "mediaType": "picture",
            "type": "product",
            "url": "https://www.breitling.com/multimedia/images/configurator2011/images_dynamic/png/ipad_hd/FFFFFF/V1331710-L543-520X-M20BASA.7.png"
        }],
        ...
        "i18n": [{
            "language": "fr-FR",
            "name": "Avenger Chronograph 45 Night Mission",
            "description": "Imposante, extrêmement robuste et résistante aux chocs, l'Avenger Chronograph 45 Night Mission combine la précision avec un design puissant dans un boîtier léger. Cette véritable Breitling Avenger peut être utilisée avec des gants et offre une sécurité et une fiabilité inégalées pour tout aventurier des airs. Dans son interprétation Night Mission, l'Avenger Chronograph 45 est équipée d'un boîtier robuste en titane avec revêtement DLC de 45 millimètres de diamètre, d'un cadran noir ou kaki et elle est proposée avec un bracelet en cuir militaire noir ou kaki assorti fermé par une boucle ardillon en acier inoxydable avec revêtement DLC ou déployante. Ses chiffres arabes spécifiques rappellent les chiffres au pochoir sur les ponts des porte-avions. Grâce à sa lunette robuste et à son relief antidérapant spécial sur la couronne et les poussoirs de chronographe, l'Avenger Chronograph 45 Night Mission peut être facilement utilisée avec des gants.\n\nDétails techniques\nDiamètre: 45.0mm, \nMatière du boîtier: Titane avec revêtement DLC, \nCouleur du cadran: Vert, \nMatière du bracelet: Cuir de veau, \nMatière de la boucle: Acier inoxydable avec revêtement DLC, \nCalibre: Breitling 13",
            "externalContents": [{
                "type": "proofLinkAction",
                "title": "Mon compte",
                "url": "https://www.breitling.com/zz-zz/my-account/ewarranty/card-certificat"
            ...
            "externalContents": [{
                ...
                "type": "website",
                "title": "Finden Sie einen Breitling-Händler in Ihrer Nähe",
                "url": "https://www.breitling.com/zz-zz/stores/"
            }]
        }, {
            "language": "es",
            "name": "Avenger Chronograph 45 Night Mission",
            "description": "Audaz, extremadamente robusto y resistente a choques, el Avenger Chronograph 45 Night Mission aúna en su caja ligera precisión y un diseño muy vigoroso. Tratándose de un Avenger de Breitling, puede usarse con guantes y garantiza seguridad y fiabilidad sin igual a los aventureros de las alturas. En su versión Night Mission, el Avenger Chronograph 45 se presenta en una rotunda caja de 45 mm de titanio con revestimiento DLC, con esfera negra o caqui y correa militar de piel negra o caqui a juego, que se cierra o bien mediante hebilla de acero inoxidable con revestimiento DLC, o bien con cierre mariposa. Los dígitos arábigos específicos del modelo aluden a los números estarcidos usados en la cubierta de los portaaviones. Gracias al resistente bisel y al dibujo especial de agarre en corona y pulsadores de cronógrafo, resulta fácil manejar el Avenger Chronograph 45 Night Mission llevando guantes.\n\nDetalles técnicos\nDiámetro: 45.0mm, \nMaterial de la caja: Titanio revestido con DLC, \nColor de la esfera: Verde, \nMaterial del brazalete: Piel de becerro, \nMaterial de la hebilla: Acero inoxidable revestido con DLC, \nCalibre: Breitling 13",
            "externalContents": [{
                "type": "proofLinkAction",
                "title": "Mi cuenta",
                "url": "https://www.breitling.com/zz-zz/my-account/ewarranty/card-certificat"
                ...
                "type": "website",
                "title": "Encuentre su distribuidor Breitling más cercano",
                "url": "https://www.breitling.com/zz-zz/stores/"
            }]
        }, {
            "language": "ja-JP",
            ...
            "externalContents": [{
                ...
                "title": "連絡先",
                "url": "https://www.breitling.com/zz-zz/contact/"
            }, {"type": "website", "title": "最寄りのブライトリングの販売店を探す", "url": "https://www.breitling.com/zz-zz/stores/"}]
        }, {
            "language": "ko-KR",
            ...
            "language": "ru",
            "name": "Авенджер Хронограф 45 Найт мишн (Avenger Chronograph 45 Night Mission)",
            "description": "Смелый дизайн, чрезвычайно прочная конструкция и ударопрочность стали отличительными чертами модели Avenger Chronograph 45 Night Mission, сочетающей в себе точность и оригинальный стиль легкого корпуса. Будучи настоящим представителем семейства Avenger, эти часы Breitling подходят для ношения с перчатками и гарантируют пилоту-любителю беспрецедентный уровень безопасности и надежности. Модель Avenger Chronograph 45 в вариации Night Mission обладает корпусом с высокопрочным углеродным покрытием (DLC) диаметром 45 мм, черным циферблатом или цвета хаки и, соответственно, армейским кожаным ремешком черного цвета или цвета хаки с классической или раскладной застежкой из нержавеющей стали с DLC-покрытием. Крупные арабские цифры по своему внешнему виду напоминают нанесенные с помощью трафарета номера военных самолетов. Благодаря наличию массивного безеля и особой формы головки подзавода с кнопками хронографа манипуляции с Avenger Chronograph 45 Night Mission можно удобно выполнять, не снимая перчатки.\n\nТехнические характеристики\nДиаметр: 45.0mm, \nМатериал корпуса : Титан с высокопрочным углеродным покрытием (DLC), \nЦвет циферблата: Зеленый, \nМатериал браслета: Телячья кожа, \nМатериал застежки: Нержавеющая сталь с высокопрочным углеродным покрытием DLC, \nМеханизм: Breitling 13",
            "externalContents": [{
                "type": "proofLinkAction",
                "title": "Мой счет",
                "url": "https://www.breitling.com/zz-zz/my-account/ewarranty/card-certificat"
                ...
                "type": "website",
                "title": "Найдите ближайшего к вам дистрибьютора Breitling",
                "url": "https://www.breitling.com/zz-zz/stores/"
            }]
        }, {
            "language": "zh-CN",
            "name": "复仇者夜间任务计时腕表45（Avenger Chronograph 45 Night Mission）",
            "description": "复仇者夜间任务计时腕表45（Avenger Chronograph 45 Night Mission）大气奔放，坚固性和抗震性优异，将出众的精确性和强劲的设计纳入一枚轻质表壳内。作为一款真正的百年灵复仇者系列（Avenger）表款，它可在佩戴手套时使用，为航空探险家提供无与伦比的安全性和可靠性。复仇者计时腕表45（Avenger Chronograph 45）夜间任务款采用坚固的45毫米类金刚石（DLC）涂层钛金属表壳，黑色或卡其色表盘分别搭配黑色或卡其色军用皮革表带，并配备类金刚石（DLC）涂层精钢针扣或折叠式表扣。特制的阿拉伯数字时标再现了航空母舰甲板上使用的钢印体数字。凭借坚固的表圈及特殊设计的表冠和计时按钮，复仇者夜间任务计时腕表45（Avenger Chronograph 48 Night Mission）在佩戴手套时亦可操控自如。\n\n技术详情\n直径: 45.0mm, \n表壳材质: 类金刚石（DLC）涂层钛金属, \n表盘颜色: 绿色, \n表链材质: 小牛皮, \n表扣材质: 类金刚石（DLC）涂层精钢, \n机芯: 百年灵13型机芯",
            "externalContents": [{
                "type": "proofLinkAction",
                "title": "我的帐户",
                "url": "https://www.breitling.com/zz-zz/my-account/ewarranty/card-certificat"
                ...
                "title": "联系方式",
                "url": "https://www.breitling.com/zz-zz/contact/"
            }, {"type": "website", "title": "寻找离您最近的百年灵零售店", "url": "https://www.breitling.com/zz-zz/stores/"}]
        }, {
            "language": "zh-TW",
            "name": "Avenger Chronograph 45 Night Mission復仇者夜間任務計時腕錶",
            "description": "Avenger Chronograph 45 Night Mission復仇者夜間任務計時腕錶造型大膽、堅固至極且抗震，精確度與強大的設計完美結合於輕質錶殼中。這款道地的百年靈Avenger復仇者腕錶佩戴手套也可以使用，能為任何空中探險家提供無與倫比的安全性和可靠性。Avenger Chronograph 45復仇者計時腕錶「夜間任務」版本採用堅固的45毫米DLC塗層鈦金屬錶殼、黑色或卡其綠錶盤，以及DLC塗層精鋼穿扣式或折疊扣同色調黑色或卡其綠軍用皮革錶帶。其特殊的阿拉伯數字讓人聯想起航空母艦甲板上使用的鋼印體數字。Avenger Chronograph 45 Night Mission復仇者夜間任務計時腕錶搭配堅固的錶圈，錶冠及計時按鈕上飾有易於把握的特殊圖案，因此戴著手套時也可以輕易操作。\n\n技術規格\n直徑: 45.0mm, \n錶殼材質: DLC塗層鈦金屬, \n錶盤顏色: 綠色, \n錶鏈材質: 小牛皮, \n錶扣材質: DLC塗層精鋼, \n機芯型號: 百年靈13機芯",
            "externalContents": [{
                "type": "proofLinkAction",
                "title": "我的帐户",
                "url": "https://www.breitling.com/zz-zz/my-account/ewarranty/card-certificat"
                ...
                "title": "联系",
                "url": "https://www.breitling.com/zz-zz/contact/"
            }, {"type": "website", "title": "查找离您最近的百年灵零售商", "url": "https://www.breitling.com/zz-zz/stores/"}]
        }, {
            "language": "pt",
            "name": "Avenger Chronograph 45 Night Mission",
            "description": "Arrojado, extremamente robusto e resistente a choques, o Avenger Chronograph 45 Night Mission combina precisão com um design poderoso numa caixa leve. Como verdadeiro Avenger da Breitling, pode ser usado com luvas e oferece segurança e fiabilidade inigualáveis a qualquer aventureiro do ar. A versão Night Mission do Avenger Chronograph 45 apresenta uma caixa resistente de 45 milímetros em titânio com revestimento DLC, mostrador preto ou caqui e bracelete militar de pele preta ou caqui a condizer com fivela ou fecho de báscula em aço inoxidável com revestimento DLC. Os seus números árabes específicos lembram os números estampados nos decks dos porta-aviões. Graças ao seu bisel robusto e ao seu padrão especial de aperto na coroa e aos botões de cronógrafo, o Avenger Chronograph 45 Night Mission pode ser facilmente manuseado com luvas.\n\nDetalhes técnicos\nDiâmetro: 45.0mm, \nMaterial da caixa: Titânio com revestimento DLC, \nCor do mostrador: Verde, \nMaterial da bracelete: Pele bovina, \nMaterial da fivela: Aço inoxidável com revestimento DLC, \nCalibre: Breitling 13",
            "externalContents": [{
                "type": "proofLinkAction",
                "title": "Minha conta",
                "url": "https://www.breitling.com/zz-zz/my-account/ewarranty/card-certificat"
                ...
                "type": "website",
                "title": "Encontre o revendedor Breitling mais próximo",
                "url": "https://www.breitling.com/zz-zz/stores/"
            }]
        }]
    };

    const expectedHash='0x16da4c2138736e5c20cf506a74d95b4b59be4ca0ad8ae402830aaef6da141231';
    const arianee = await new Arianee().init(NETWORK.arianeeTestnet);
    const wallet = arianee.fromRandomMnemonic();
    const hash = await wallet.utils.cert(ArianeeProductCertificate, content);
    expect(hash).toBe(expectedHash);
